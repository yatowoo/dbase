...
FairDbWtFileEditDialog::FairDbWtFileEditDialog(WAbstractItemModel *model, const WModelIndex& item)
          ...
          item_(item)
  {
    ...
    createdPicker_->setFormat(FairDbWtFileModel::dateEditFormat);
    ...
    modifiedPicker_->setFormat(FairDbWtFileModel::dateEditFormat);
...
void FairDbWtFileEditDialog::handleFinish(DialogCode result)
  {
