#ifndef CBMSTSWTQASENSORCHANNELMAPMODEL_H
#define CBMSTSWTQASENSORCHANNELMAPMODEL_H
...
class CbmStsWtQaSensorChannelMapModel : public Wt::WAbstractTableModel
{
 public:
  CbmStsWtQaSensorChannelMapModel(int id, int rows, int columns=3, Wt::WObject *parent = 0);
