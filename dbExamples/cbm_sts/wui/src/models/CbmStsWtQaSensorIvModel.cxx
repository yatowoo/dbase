...
WString CbmStsQaSensorIvModel::dateDisplayFormat(WString::fromUTF8("MMM dd, yyyy"));
WString CbmStsQaSensorIvModel::dateEditFormat(WString::fromUTF8("dd-MM-yyyy"));


CbmStsQaSensorIvModel::CbmStsQaSensorIvModel(int id, int rows, int columns, WObject *parent)
...
int CbmStsQaSensorIvModel::rowCount(const Wt::WModelIndex& parent) const
{
    if (!parent.isValid())
      return rows_;
    else
...
int CbmStsQaSensorIvModel::columnCount(const Wt::WModelIndex& parent ) const
{
    if (!parent.isValid())
      return columns_;
    else
...
boost::any CbmStsQaSensorIvModel::data(const Wt::WModelIndex& index, int role) const
{
...
boost::any CbmStsQaSensorIvModel::headerData(int section, Wt::Orientation orientation, int role) const
{
...
void CbmStsQaSensorIvModel::fillheader()
{
...
void CbmStsQaSensorIvModel::fillrows(int rid)
{
