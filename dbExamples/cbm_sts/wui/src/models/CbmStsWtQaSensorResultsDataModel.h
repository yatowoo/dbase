#ifndef CBMSTSQASENSORRESULTSDATAMODEL_H
#define CBMSTSQASENSORRESULTSDATAMODEL_H
...
class CbmStsQaSensorResultsDataModel : public Wt::WAbstractTableModel
{
public:
  CbmStsQaSensorResultsDataModel(int rows, int columns=12, Wt::WObject *parent = 0);
