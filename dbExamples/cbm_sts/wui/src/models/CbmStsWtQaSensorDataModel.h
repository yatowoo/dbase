#ifndef CBMSTSWTQASENSORDATAMODEL_H
#define CBMSTSWTQASENSORDATAMODEL_H
...
namespace Models{
  ...
  class CbmStsWtQaSensorDataModel : public Wt::WAbstractTableModel
  {
  public:
    CbmStsWtQaSensorDataModel(int rows, int columns=18, Wt::WObject *parent = 0);
    ...
    void setSelection(const string& vendor, const string& batch_id);
    void fillheader();
