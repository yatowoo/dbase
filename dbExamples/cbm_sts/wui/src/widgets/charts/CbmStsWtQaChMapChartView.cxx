...
#include "CbmStsWtQaChMapChartView.h"
...
CbmStsWtQaChMapTableChartView::CbmStsWtQaChMapTableChartView(Wt::WContainerWidget *parent):
  WContainerWidget(parent)
{
...
CbmStsWtQaChMapChartView::CbmStsWtQaChMapChartView(int sid, WContainerWidget *parent):
  WContainerWidget(parent)
  ,fInit(false)
  ,fName("")
  ,fUID(0)
...
void CbmStsWtQaChMapChartView::initChMapContainer( int sid, int rid)
{
