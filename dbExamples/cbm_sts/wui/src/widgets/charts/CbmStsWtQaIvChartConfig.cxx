#include "CbmStsWtQaIvChartConfig.h"
...
CbmStsWtQaIvChartConfig::CbmStsWtQaIvChartConfig(WCartesianChart *chart, WContainerWidget *parent)
    ...
    fill_(MinimumValueFill)
{
  ...
  CbmStsWtQaIvPanelList *list = new CbmStsWtQaIvPanelList(this);
  ...
  if (!WApplication::instance()->environment().javaScript()) {
    ...
    b->clicked().connect(this, &CbmStsWtQaIvChartConfig::update);
  }
}

void CbmStsWtQaIvChartConfig::setValueFill(FillRangeType fill)
{
  fill_ = fill;
}

void CbmStsWtQaIvChartConfig::update()
{
...
bool CbmStsWtQaIvChartConfig::validate(WFormWidget *w)
{
...
void CbmStsWtQaIvChartConfig::connectSignals(WFormWidget *w)
{
  w->changed().connect(this, &CbmStsWtQaIvChartConfig::update);
  if (dynamic_cast<WLineEdit *>(w))
    w->enterPressed().connect(this, &CbmStsWtQaIvChartConfig::update);
}
