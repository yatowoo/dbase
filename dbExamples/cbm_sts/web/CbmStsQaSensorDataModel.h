#ifndef CBMSTSQASENSORDATAMODEL_H
#define CBMSTSQASENSORDATAMODEL_H
...
class CbmStsQaSensorDataModel : public Wt::WAbstractTableModel
{
public:
  CbmStsQaSensorDataModel(int rows, int columns=18, Wt::WObject *parent = 0);
