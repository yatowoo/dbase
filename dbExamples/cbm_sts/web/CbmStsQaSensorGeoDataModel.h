#ifndef CBMSTSQASENSORGEODATAMODEL_H
#define CBMSTSQASENSORGEODATAMODEL_H
...
class CbmStsQaSensorGeoDataModel : public Wt::WAbstractTableModel
{
public:
  CbmStsQaSensorGeoDataModel(int rows, int columns=12, Wt::WObject *parent = 0);
