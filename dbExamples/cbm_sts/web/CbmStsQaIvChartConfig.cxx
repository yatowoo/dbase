...
CbmStsQaIvChartConfig::CbmStsQaIvChartConfig(WCartesianChart *chart, WContainerWidget *parent)
    ...
    fill_(MinimumValueFill)
{
  ...
  CbmStsQaIvPanelList *list = new CbmStsQaIvPanelList(this);
  ...
  if (!WApplication::instance()->environment().javaScript()) {
    ...
    b->clicked().connect(this, &CbmStsQaIvChartConfig::update);
  }
}

void CbmStsQaIvChartConfig::setValueFill(FillRangeType fill)
{
  fill_ = fill;
}

void CbmStsQaIvChartConfig::update()
{
...
bool CbmStsQaIvChartConfig::validate(WFormWidget *w)
{
...
void CbmStsQaIvChartConfig::connectSignals(WFormWidget *w)
{
  w->changed().connect(this, &CbmStsQaIvChartConfig::update);
  if (dynamic_cast<WLineEdit *>(w))
    w->enterPressed().connect(this, &CbmStsQaIvChartConfig::update);
}
