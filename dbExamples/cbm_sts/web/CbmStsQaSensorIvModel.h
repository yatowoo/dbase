#ifndef CBMSTSQASENSORIVMODEL_H
#define CBMSTSQASENSORIVMODEL_H
...
class CbmStsQaSensorIvModel : public Wt::WAbstractTableModel
{
public:
  CbmStsQaSensorIvModel(int id, int rows, int columns=3, Wt::WObject *parent = 0);
