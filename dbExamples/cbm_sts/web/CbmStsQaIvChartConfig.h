#ifndef CBMSTSQAIVCHARTCONFIG_H_
#define CBMSTSQAIVCHARTCONFIG_H_
...
class CbmStsQaIvChartConfig : public Wt::WContainerWidget
{
public:

  CbmStsQaIvChartConfig(Wt::Chart::WCartesianChart *chart, Wt::WContainerWidget *parent);
