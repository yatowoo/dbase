#ifndef CBMSTSQASENSORDATAMODELNEW_H
#define CBMSTSQASENSORDATAMODELNEW_H
...
class CbmStsQaSensorDataModelNew : public Wt::WAbstractTableModel
{
public:
  CbmStsQaSensorDataModelNew(int rows, int columns=18, Wt::WObject *parent = 0);
