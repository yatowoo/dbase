...
WString CbmStsQaSensorChannelMapModel::dateDisplayFormat(WString::fromUTF8("MMM dd, yyyy"));
WString CbmStsQaSensorChannelMapModel::dateEditFormat(WString::fromUTF8("dd-MM-yyyy"));


CbmStsQaSensorChannelMapModel::CbmStsQaSensorChannelMapModel(int id, int rows, int columns, WObject *parent)
...
int CbmStsQaSensorChannelMapModel::rowCount(const Wt::WModelIndex& parent) const
{
    if (!parent.isValid())
      return rows_;
    else
...
int CbmStsQaSensorChannelMapModel::columnCount(const Wt::WModelIndex& parent ) const
{
    if (!parent.isValid())
      return columns_;
    else
...
boost::any CbmStsQaSensorChannelMapModel::data(const Wt::WModelIndex& index, int role) const
{
...
boost::any CbmStsQaSensorChannelMapModel::headerData(int section, Wt::Orientation orientation, int role) const
{
...
void CbmStsQaSensorChannelMapModel::fillheader()
{
...
void CbmStsQaSensorChannelMapModel::fillrows(int rid)
{
