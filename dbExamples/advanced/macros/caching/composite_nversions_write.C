void composite_nversions_write(){
  //
  //
  // Purpose: - Write multiple version of composite data
  //            to database table
  //          
  ...
  Test_t tests[] = {
    {20140101, 000000, 20160131,  000000, 0, 0, 20, 30, 110, 102., 103., 111.}
    {20140101, 000000, 20160131,  000000, 0, 1, 20, 30, 110, 202., 203., 211.}
    {20140101, 000000, 20160131,  000000, 0, 2, 20, 30, 110, 302., 303., 211.}
    {20140101, 000000, 20160131,  000000, 1, 0, 50, 80, 130, 105., 108., 113.}
    {20140101, 000000, 20160131,  000000, 1, 1, 50, 80, 130, 205., 208., 213.}    
  };
  ...
  for (int itest=0; itest<N_TESTS; ++itest ) {
    ...
    w_par2.Activate(range,  aPar2.GetCompId(), aPar2.GetVersion(),
